...
import ErrorCard from '../error-card/index';
import './mouldErrorList.less';
...
class mouldErrorList extends Component {
    constructor(props) {
        super(props);
    ...
    getList = (param = {}) => {
        xhr.get(url.getErrorList, param, (data) => {
            // let param = param;
            this.setState({
                data: data.rows,
        ...
        return (
            <div className="mouldList">
                <div className="toolbar">
                    <div className="searchFilter">
                        <Select className="tool" size={this.state.size} style={{width: 200}}
                                onChange={this.chooseStatus} placeholder="处理状态">{errorState}</Select>
                ...
                <div className="content" ref="content">
                    <ErrorCard data={this.state.data} />
                </div>
